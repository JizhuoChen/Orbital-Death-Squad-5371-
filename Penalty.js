...
$(function() {
    ...
    //var value = parameters[i].substr(m2+1, m1-m2);//Get the specific value after the = sign for each key-value pai
    //paValue[i] = value;
...
insight.addEventListener ("click", (e) => {
    window.location.replace("Seats Insight.html?"+parmeter);
})
