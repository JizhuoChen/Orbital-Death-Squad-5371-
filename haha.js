...
PHAK.addEventListener("click", (e) => {
    if (seatSelected <= 100) {
        ...
        if (judge == 0) {
            ...
            alert("Number of penalties reached three，your booking privilege has been suspended!");
        }
        else if (judge == 2) {
            alert("You have reserved 6 seats(max) already!");
        }
        else {
            alert("You already have a booking at the same date and time. Please choose another time slot!");
        }
    }
    else {
