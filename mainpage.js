...
$(function() {
    ...
    booking.addEventListener ("click", (e) => {
        window.location.href="Booking Seats.html?"+loc;
    })
    
    frontpage.addEventListener ("click", (e) => {
        window.location.href="mainpage1.html?"+loc;
    })
    
    insight.addEventListener ("click", (e) => {
        window.location.href="Seats Insight.html?"+loc;
    })
    
    activity.addEventListener ("click", (e) => {
        window.location.href="My Activity.html?"+loc;
    })
    
    penalty.addEventListener ("click", (e) => {
        window.location.href="Penalty.html?"+loc;
    })